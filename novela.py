...
mostrar_mensaje("Cada vez te encariñas más con el sonido de las olas y el olor de la brisa se te hace cada vez más familiar.")
...
mostrar_mensaje(f"{YELLOW}¿Qué haces?\n")
time.sleep(1)
